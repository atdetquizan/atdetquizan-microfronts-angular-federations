...
import { SafeHtmlPipe } from 'src/app/pipes';
...
export class TabsComponent implements OnInit {
  /**
   * Tab active of tabs component
   */
  tabActive = 0;
  /**
   * Tabs  of tabs component
   */
  tabs = [
    {
      title: 'Publicaciones',
    ...
    },
    {
      title: 'Guardadas',
      path: '/profile/saved',
      icon: '<svg aria-label="" class="x1lliihq x1n2onr6 x1roi4f4" fill="currentColor" height="12" role="img" viewBox="0 0 24 24" width="12"><title></title><polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></polygon></svg>',
    },
    {
      title: 'Etiquetadas',
      path: '/profile/tagged',
  ...
  /**
   * Output  of tabs component
   */
  @Output() changeTab: EventEmitter<any> = new EventEmitter<any>();

  /**
   * Creates an instance of tabs component.
   * @param {Router} router 
   */
   ...
   */
  ngOnInit(): void {
    this.tabActive = this.tabs.findIndex((item) => item.path === this.router.url);
  }
  /**
   * Determines whether click tab on
   * @param {any} item 
   * @param {number} index 
   */
