  ...
  sidebar = [
    {
      title: 'Inicio',
      path: '/',
      icon: '<svg aria-label="Inicio" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Inicio</title><path d="M9.005 16.545a2.997 2.997 0 0 1 2.997-2.997A2.997 2.997 0 0 1 15 16.545V22h7V11.543L12 2 2 11.543V22h7.005Z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg>',
    },
    {
      title: 'Búsqueda',
    ...
    },
    {
      title: 'Perfil',
      path: '/profile',
      icon: '<div class="image-circle"><img width="20" height="20" src="https://static.vecteezy.com/system/resources/previews/009/397/835/non_2x/man-avatar-clipart-illustration-free-png.png"/></div>'
    },
  ];

  constructor(private router: Router) {}

  onClickNavegation(item: any) {
    if (item.path) {
